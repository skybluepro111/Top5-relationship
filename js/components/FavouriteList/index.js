...
import ContactCell from "../contactList/contactCell";
...
class FavouriteList extends Component {
  ...
  getContactCellList(){
      ...
      contacts.map((contact) => {
          ...
          if(this.checkIsFavourite(contact) && name.toUpperCase().includes(this.state.searchStr.toUpperCase())){
...
FavouriteList.navigationOptions = {
  header: null
};

export default connect(mapStateToProps, bindAction)(FavouriteList);
